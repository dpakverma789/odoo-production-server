...
class GymExpense(models.Model):
    ...
    # _sql_constraints = [('unique_bill_from', 'unique (bill_from,created_by)', "Expense already created for this FROM date !"),
    #                     ('unique_bill_to', 'unique (bill_to,created_by)', "Expense already created for this TO date !")]
